...
public class QuizActivity extends AppCompatActivity {
    ...
    private boolean mIsCheater;     //Variable to hold the value that CheatActivity is passing back
    ...
    /* Later modified to check whether the user cheated and to respond appropriately. */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCheatButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                //Method used to hear back form the child adctivity
                startActivityForResult(i, REQUEST_CODE_CHEAT); //'REQUEST_CODE_CHEAT', is a user-defined integer that is sent to the child activity
                                                              //             and then received back by the parent
            }
        });

        //Check if savedInstanceState exists, and if so, assign it to mCurrentIndex
        //This allows an item in the list (array) of questions to show the current question in between rotations of vertical/horizontal layouts
    ...
    /* To retrieve the value that CheatActivity is passing back, checking the request code and
     * result code go be sure they are what is expected. */
    @Override
